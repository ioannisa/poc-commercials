...
import eu.anifantakis.commercials.feature.user_management.presentation.screens.admin_update.AdminAppUpdateViewModel
...
val userManagementModule = module {
    ...
    viewModelOf(::AdminAppUpdateViewModel)
}
