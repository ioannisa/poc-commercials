 ...
 * and for persisting the user's choice. [isRtl] marks right-to-left scripts:
 * [LocalizationProvider] derives the composition's `LocalLayoutDirection`
 * from it, so the whole UI mirrors when such a language is active.
 */
