...
private fun LoginScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        // Full-screen background image behind the card - covers the white area.
        // Crop fills the screen without letterboxing; decorative, so
        // contentDescription is null (the card is the content).
        AppImage(
