...
include(":reports-model")
include(":reports-client")
include(":feature:ai-chat:domain")
include(":feature:ai-chat:data")
include(":feature:ai-chat:presentation")
...
include(":feature:galaxy-bridge:domain")
include(":feature:galaxy-bridge:data")
include(":feature:galaxy-bridge:presentation")
